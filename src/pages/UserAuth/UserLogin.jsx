        ...
        <div className='grid grid-cols-12 h-screen'>
            ...
            <div className='md:col-span-8 col-span-12 bg-white'>
                <div className='flex justify-center items-center flex-col h-full'>
                    <h1 className='text-3xl'>לחץ וזוז - ברוך הבא</h1>
                    ...
                    <div className='flex flex-col'>
                        ...
                        <button className='bg-[#2676E5] w-full text-white p-2 mt-5 rounded-md' onClick={handleLoginClick}>התחברות</button>
                        <p className='text-center mt-10'>אין לך עדיין חשבון? <span className='text-[#2676E5]'><Link to="/userregister">הירשם כאן</Link></span></p>
                    </div>
                </div>
            </div>
        </div >
