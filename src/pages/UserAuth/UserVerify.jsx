            ...
            <div className='md:col-span-8 col-span-12 bg-white'>
                <div className='flex justify-center items-center flex-col h-full'>
                    ...
                    <div className='flex flex-col mt-5'>
                        ...
                        <p className='text-center'><span className='text-[#2676E5]'><Link to="/userregister">Resend Email</Link></span> or <span className='text-[#2676E5]'><Link to="/userregister">Sign in with different email address.</Link></span></p>
                    </div>
                </div>
            </div>
        </div >
